...
export const PhysicalVerificationKYCRequestTab = ({ id }: { id: string }) => {
  const pathname = usePathname();

  const tabs = [
    {
      name: "Personal Details",
      href: `/physical-verification/kyc-request-details/${id}/personal-details`,
    },
    {
      name: "Address Verification",
      href: `/physical-verification/kyc-request-details/${id}/address-verification`,
    },

    {
      name: "Additional Comment",
      href: `/physical-verification/kyc-request-details/${id}/additional-comment`,
    },
  ];
