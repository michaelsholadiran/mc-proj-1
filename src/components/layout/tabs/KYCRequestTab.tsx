...
export const KYCRequestTab = ({ id }: { id: string }) => {
  const pathname = usePathname();

  const tabs = [
    {
      name: "Personal Details",
      href: `/dashboard/kyc-requests/${id}/personal-details`,
    },
    {
      name: "Address Verification",
      href: `/dashboard/kyc-requests/${id}/address-verification`,
    },
    {
      name: "KYC Details",
      href: `/dashboard/kyc-requests/${id}/kyc-details`,
    },
    {
      name: "Additional Comment",
      href: `/dashboard/kyc-requests/${id}/additional-comment`,
    },
  ];
